...
urlpatterns = [
    ...
    path("crm/", views.dashboard, name="dashboard"), path("crm/pipeline/", views.admission_pipeline, name="admission_pipeline"), path("crm/module/<str:module>/", views.module_dashboard, name="module_dashboard"), path("crm/leads/<int:pk>/", views.lead_detail, name="lead_detail"),
